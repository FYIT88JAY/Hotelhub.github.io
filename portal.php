...
<header class="masthead">
	<div class="slider">
        <div class="slides">
			<a href="#home">View Hotels</a>
			<img src="assets/img/slider-img1.jpg" data-src="assets/img/slider-img1.jpg" class="slider-image">
        </div>
        <div class="slides">
			<a href="#home">View Hotels</a>
            <img src="assets/img/slider-img2.jpg" data-src="assets/img/slider-img2.jpg" class="slider-image">
        </div>
        <div class="slides">
			<a href="#home">View Hotels</a>
            <img src="assets/img/slider-img3.jpg" data-src="assets/img/slider-img3.jpg" class="slider-image">
        </div>
        <button class="slider-button slider-button-left">&larr;</button>
        <button class="slider-button slider-button-right">&rarr;</button>
        <div class="dots"></div>
    </div>
	<!-- <div class="container">
		<div class="masthead-subheading">Welcome To Hotel Hub</div>
		<div class="masthead-heading text-uppercase">Book Hotels</div>
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">View Hotels</a>
	</div> -->
</header>
<!-- Services-->
<section class="page-section bg-dark" id="home">
	<div class="container">
		...
		<div class="d-flex w-100 justify-content-end">
			<a href="./?page=packages" class="btn btn-flat btn-warning mr-4">View More<i class="fa fa-arrow-right"></i></a>
		</div>
	</div>
</section>
<!--About-->
