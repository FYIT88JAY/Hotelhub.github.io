<section class="page-section bg-dark" id="home">
	<div class="container">
		...
		<h2 class="text-center">View Hotels</h2>
		...
		?>
            <div class="card w-100 rounded-0">
                ...
                <div class="w-100 d-flex justify-content-end">
					...
					<a href="./?page=packages&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning">View Hotels <i class="fa fa-arrow-right"></i></a>
                </div>
                </div>
            </div>
		<?php endwhile; ?>
	...
	<div class="d-flex w-100 justify-content-end">
		...
		<a href="./?page=packages" class="btn btn-flat btn-warning mr-4">Hotels details <i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>